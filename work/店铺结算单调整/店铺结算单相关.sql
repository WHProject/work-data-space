...
INSERT INTO `zntg_admin`.`adm_Power` (`ID`, `ParentID`, `PowerName`, `Url`, `Sort`, `Type`, `State`, `CreateTime`, `ModifyTime`, `Ext1`) VALUES ('1254', '858', '结算单付款', '/settlementPayment/index.htm', '6', '2', '1', '2017-04-25 15:19:35', NULL, NULL);
INSERT INTO `zntg_admin`.`adm_Power` (`ID`, `ParentID`, `PowerName`, `Url`, `Sort`, `Type`, `State`, `CreateTime`, `ModifyTime`, `Ext1`) VALUES ('1255', '1254', '确认付款', '/settlementPayment/confirmPayment.htm', '1', '3', '1', '2017-04-25 15:22:27', NULL, NULL);
